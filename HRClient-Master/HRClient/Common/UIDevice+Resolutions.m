...
/******************************************************************************
 函数名称 : + (UIDeviceScreenSize) currentScreenSize
 函数描述 : 获取当前屏幕大小
 输入参数 : N/A
 输出参数 : N/A
 返回参数 : N/A
 备注信息 :
 ******************************************************************************/
+ (UIDeviceScreenSize) currentScreenSize
{
    if (UI_USER_INTERFACE_IDIOM() == UIUserInterfaceIdiomPhone)
    {
        if ([UIDevice currentResolution] == UIDevice_iPhoneHiRes || [UIDevice currentResolution] == UIDevice_iPhoneStandardRes){
            return UIDevice_3_5_Inch;
        }
        else if ([UIDevice currentResolution] == UIDevice_iPhoneTallerHiRes){
            return UIDevice_4_0_Inch;
        }
    }
